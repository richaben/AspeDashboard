...
# pak::pkg_install(c("karthik/rdrop2", "dreamRs/shinylogs"))
...
```{r}
get_data_poissons <- function(endpoint, stations = NULL, ..., ntry_max = 25) {
  cat("\n#", endpoint, file = "log")
...
if (download_hubeau) {
  ...
  new_observations <- get_data_poissons(
    ...
    stations = unique(new_operations$code_station), 
    code_departement = dept_test,
    fields = "code_operation,code_alternatif_taxon,effectif_lot"
    ) |>
