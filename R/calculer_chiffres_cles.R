...
#'
#' @description Calcule des indicateurs synthétiques (nombre de stations, 
#' nombre de taxons, etc.) pour une sélection de données.
#'
#' @param donnees Un data.frame contenant les données filtrées.
#' @param variable La variable d'intérêt ("ipr" ou "especes").
#'
#' @return Une liste contenant les chiffres clés formatés en HTML.
#' @export
#'
#' @importFrom dplyr group_by summarise n_distinct filter ungroup distinct mutate reframe case_when count pull arrange factor
